          ...
          <div className="mx-auto max-w-7xl space-y-6">
            <div className="bg-card rounded-lg p-6 shadow">
              <h2 className="mb-4 text-xl font-semibold">
                {locale === 'en' ? 'Staff Directory' : 'دليل الموظفين'}
              </h2>
              <p className="text-muted-foreground">
                {locale === 'en' 
                  ? 'This section is under development. Staff management features will be available in the next release.' 
                  : 'هذا القسم قيد التطوير. ستتوفر ميزات إدارة الموظفين في الإصدار التالي.'}
              </p>
            </div>
          </div>
        </main>
