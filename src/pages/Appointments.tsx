          ...
          <div className="mx-auto max-w-7xl space-y-6">
            <div className="bg-card rounded-lg p-6 shadow">
              ...
              <p className="text-muted-foreground">
                {locale === 'en' 
                  ? 'This section is under development. Appointment management features will be available in the next release.' 
                  : 'هذا القسم قيد التطوير. ستتوفر ميزات إدارة المواعيد في الإصدار التالي.'}
              </p>
            </div>
          </div>
        </main>
